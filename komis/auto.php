...
$imgStmt = $pdo->prepare("SELECT image_path FROM car_images WHERE car_id = ? ORDER BY sort_order ASC, id ASC");
$imgStmt->execute([$id]);
$images = $imgStmt->fetchAll(PDO::FETCH_COLUMN);

// Dane kontaktowe w stopce (stałe dla strony)
...
<body>
  ...
  <footer class="site-footer">
    <div class="container">
      <div>Kontakt: <?= htmlspecialchars($SITE_EMAIL) ?> • 509 465 286 • 692 869 364</div>

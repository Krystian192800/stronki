...
// ------------------ Kursy walut ------------------
$kurs_euro = 0.23; // 1 zł = 0.23 EUR (zmień na aktualny kurs)
...
$i18n = [
  'pl' => [
    'title' => 'Ogłoszenia Aut Osobowych',
...
<main class="container">
  <div class="grid">
    <?php foreach ($cars as $car): ?>
      <a class="card" href="auto2.php?id=<?= (int)$car['id'] ?>">
        <div class="card-img">
